...
exports.WPT_TEST_CASES = void 0;
const IMG_URL = 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==';
/**
...
exports.WPT_TEST_CASES = [
    ...
    },
    {
        ...
        htmlInput: `
          ...
          <div id="test" role="link" tabindex="0">
            ...
            <div><img src="${IMG_URL}" title="Bryan" alt="" role="presentation" /></div>
    ...
    },
    {
        ...
        expectedName: '1',
        htmlInput: `
            <img id="test" aria-labelledby="test" aria-label="1" src="${IMG_URL}"/>
        `,
    },
    {
    ...
    },
    {
        ...
        htmlInput: `
            <input type="text" value="peanuts" id="ID1">
          <img id="test" aria-label="l" aria-labelledby="test ID1" src="${IMG_URL}"/>
        `,
    },
    {
        ...
        htmlInput: `
            <input type="text" value="peanuts" id="ID1">
          <input type="text" value="popcorn" id="ID2">
          <img id="test" aria-label="l" aria-labelledby="test ID1 ID2" src="${IMG_URL}"/>
        `,
    },
    {
        ...
        htmlInput: `
          ...
          <input type="text" value="popcorn" id="ID2">
          <input type="text" value="apple jacks" id="ID3">
          <img id="test" aria-label="l" aria-labelledby="test ID1 ID2 ID3" alt= "a" title="t" src="${IMG_URL}"/>
        `,
    },
    {
        ...
        htmlInput: `
          ...
          <input type="text" value="popcorn" id="ID2">
          <input type="text" value="apple jacks" id="ID3">
          <img id="test" aria-label="" aria-labelledby="test ID1 ID2 ID3" alt="" title="t" src="${IMG_URL}"/>
        `,
    },
    {
    ...
    },
    {
        ...
        htmlInput: `
          ...
          <form>
            <label for="test"><input id="test" type="image" src="${IMG_URL}" name="test" title="bar"></label>
          </form>
        `,
    },
    {
...
//# sourceMappingURL=wpt_testdata.js.map